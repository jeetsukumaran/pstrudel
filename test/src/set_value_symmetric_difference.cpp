...
int main(int argc, const char * argv[]) {
    ...
    pstrudel::SymmetricDifferenceTree::SizesSetType set1(data[0].begin(), data[0].end());
    pstrudel::SymmetricDifferenceTree::SizesSetType set2(data[1].begin(), data[1].end());
    pstrudel::SymmetricDifferenceTree::SizesSetType common;
    pstrudel::SymmetricDifferenceTree::SizesSetType unmatched1;
    pstrudel::SymmetricDifferenceTree::SizesSetType unmatched2;
    unsigned long sdiff = pstrudel::SymmetricDifferenceTree::calc_set_symmetric_difference(set1, set2, &common, &unmatched1, &unmatched2);
    std::cout << sdiff << std::endl;

    dump_results(common);
    std::cout << std::endl;

    pstrudel::SymmetricDifferenceTree::SizesSetType combined_unmatched;
